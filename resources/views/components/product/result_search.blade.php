<x-home>
    <div class="flex mt-3 justify-between">
        <h2 class="ml-2 font-bold font-serif content-center text-2xl">Data Products '{{ $query }}'</h2>
        <a href="{{ route('product_page') }}">
            <button class="border p-2 rounded-md mr-3 bg-green-500 hover:bg-green-400">
